...
$names = @(
    ...
    "ModeResetTextPosition", "ModeQuickChain", "ModeQuickChainAngle"
)
...
function Draw-Icon($name, $path, [int]$scale) {
    ...
    switch ($name) {
        ...
        "ModeQuickChainAngle" { Draw-Arrow $graphics $main 3 4 8 9; Draw-Arrow $graphics $main 13 14 8 9; Draw-Arrow $graphics $accent 8 9 23 18; Draw-Line $graphics $accent 8 2 8 10 }
    }
