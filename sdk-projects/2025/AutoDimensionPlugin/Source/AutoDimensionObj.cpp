...
#ifdef _WINDOWS
		"C:\\Users\\keepl\\Downloads\\VectorworksAutoDimensionPlugin\\vw-autodim-runtime-2025.txt";
#else
		"/tmp/vw-autodim-runtime-2025.txt";
#endif
...
bool CAutoDimensionObjDefTool_EventSink::DoSetUp(bool bRestore, const IToolModeBarInitProvider* pModeBarInitProvider)
{
	...
	buttonHelp.Append(VectorWorks::SModeBarButtonHelp("图块手动定位", "先点对象，再点标注放置位置。", VectorWorks::eModeBarButtonType_RadioMode));
	buttonHelp.Append(VectorWorks::SModeBarButtonHelp("交线标注", "选中至少两条相交线，标注交线关系。", VectorWorks::eModeBarButtonType_RadioMode));
	...
	buttonHelp.Append(VectorWorks::SModeBarButtonHelp("边界标注", "选中多个图块，标注整体边界。", VectorWorks::eModeBarButtonType_RadioMode));
	...
	buttonHelp.Append(VectorWorks::SModeBarButtonHelp("转换标注", "将选中的标注转换为对齐标注。", VectorWorks::eModeBarButtonType_RadioMode));
